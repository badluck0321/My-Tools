...
const MasteryHistory = () => {
  ...
  useEffect(() => {
    ...
    masteryService
      ...
      .catch((err) => {
        console.error(err);
        setError(t("masteryHistory.failedToLoad"));
      })
