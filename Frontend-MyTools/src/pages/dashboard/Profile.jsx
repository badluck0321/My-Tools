...
const Profile = () => {
  ...
  return (
    <motion.div
      ...
      <motion.div
        layout
        className="bg-[#f5f5f3] dark:bg-gradient-to-br dark:from-[#3a3633] dark:to-[#2d2a27] backdrop-blur-xl rounded-3xl shadow-xl dark:shadow-2xl border border-[#e8e7e5] dark:border-[#4a4642] p-8">
      ...
      <motion.div
        ...
        <h3 className="text-lg font-semibold text-[#2d2a27] dark:text-[#fafaf9] mb-4">
          Account Information
        </h3>
