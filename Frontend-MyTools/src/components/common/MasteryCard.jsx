      ...
      <motion.div
        ...
        <div className="relative aspect-square overflow-hidden">
          ...
          <button
            onClick={handleLike}
            disabled={loading}
            className={`absolute top-4 right-4 p-2 rounded-full backdrop-blur-md transition-all duration-300 disabled:opacity-60 ${
              isLiked
