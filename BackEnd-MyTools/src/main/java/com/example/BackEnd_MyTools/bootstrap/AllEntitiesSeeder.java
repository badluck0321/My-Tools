...
public class AllEntitiesSeeder {
        ...
        private void seedMasteries() throws IOException {
                ...
                masteryRepo.saveAll(List.of(
                                ...
                                mastery("M004", "Fatima Zahra", "0600000004", "House Cleaning", "ACTIVE", 3, "PER_HOUR",
                                                80,
                                                "Marrakech", 2, "Professional home and office cleaning",
                                                List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396899/house_wife_tpqq4x.png")),
                                mastery("M005", "Omar Haddad", "0600000005", "Air Conditioning Repair", "ACTIVE", 1,
                                                "FIXED", 500,
                                ...
                                mastery("M009", "Mehdi Azizi", "0600000009", "Web Development", "ACTIVE", 6, "PER_HOUR",
                                                200,
                                ...
                                mastery("M013", "Adil Najib", "0600000013", "Photography", "ACTIVE", 8, "FIXED", 800,
                                                "Marrakech", 7,
                                                "Event and portrait photographer",
                                                List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396903/photographer_tmrskx.png")),
                                mastery("M014", "Laila Bennani", "0600000014", "Yoga Instructor", "ACTIVE", 9,
                                                "PER_HOUR", 100, "Rabat",
                                ...
                                mastery("M015", "Anas Fassi", "0600000015", "IT Support", "ACTIVE", 6, "PER_HOUR", 130,
                                                "Casablanca", 4,
                                                "Technical IT troubleshooting",
                                                List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396912/tech_support_b5wce8.png")),
                                mastery("M016", "Hiba El Amrani", "0600000016", "Interior Design", "ACTIVE", 8, "FIXED",
                                                1200,
                                                "Tangier", 6, "Modern home interior designer",
                                                List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396919/Designer_u7vac6.png")),
                                mastery("M017", "Mustapha Reda", "0600000017", "Welding Services", "ACTIVE", 1, "FIXED",
                                                450, "Fes", 9,
                                                "Metal welding and fabrication",
                                                List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396918/welder_dsxmz4.png")),
                                mastery("M018", "Zineb Ghali", "0600000018", "Language Tutor", "ACTIVE", 7, "PER_HOUR",
                                                110,
                                ...
                                mastery("M019", "Ayoub Jaber", "0600000019", "Delivery Service", "ACTIVE", 10, "FIXED",
                                                60,
                                ...
                                mastery("M020", "Kawtar Mernissi", "0600000020", "Hair Stylist", "ACTIVE", 8,
                                                "PER_HOUR", 180, "Rabat",
                                ...
                                mastery("M021", "Yassine El Idrissi", "0600000021", "Security Services", "ACTIVE", 11,
                                                "FIXED", 500,
                                ...
                                mastery("M022", "Nour El Houda", "0600000022", "Catering Service", "ACTIVE", 12,
                                                "FIXED", 1500,
                                ...
                                mastery("M027", "Redouane Fadil", "0600000027", "Furniture Assembly", "ACTIVE", 1,
                                                "FIXED", 250,
                                ...
                                mastery("M028", "Meryem Saidi", "0600000028", "Event Planning", "ACTIVE", 8, "FIXED",
                                                2000, "Marrakech",
                                                7, "Wedding and corporate event planner",
                                                List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396911/traiteur_ysqp98.png")),
                                mastery("M029", "Bilal Ait", "0600000029", "Locksmith", "ACTIVE", 1, "FIXED", 350,
                                                "Fes", 6,
                                                "Emergency lock and key services",
                                                List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396900/locksmith_kvb4qa.png")),
                                mastery("M030", "Siham Laaroussi", "0600000030", "Nutrition Coaching", "ACTIVE", 9,
                                                "PER_HOUR", 160,
                ...
                if (photoUrls != null && !photoUrls.isEmpty()) {
                        ...
                        for (String imageUrl : photoUrls) {
                                try {
                                        ...
                                        System.err.println("[Seeder] Image upload failed for: " + m.masterName + " - "
                                                        + m.title);
                                        e.printStackTrace();
                                }
                        }
        ...
        private void seedVendorVerifications() throws IOException {
                ...
                v.setDocumentPhotoId(
                                photoService.saveGeneratedImage("Rabat Pro Tools", "Trade register demo document"));
                ...
                p.setDocumentPhotoId(
                                photoService.saveGeneratedImage("Casa Digital Repairs", "Pending identity document"));
