...
public class AllEntitiesSeeder {
    ...
    public void seedAll() {
        try {
            ...
            throw new RuntimeException("Failed to generate demo seed images", e);
        }
    }
    ...
    private void seedLookups() {
        ...
        for (String[] row : List.of(
                ...
                new String[] { "CATEGORY", "4", "Measurement" }, new String[] { "CATEGORY", "5", "Transport" },
                new String[] { "CATEGORY", "6", "IT & Electronics" },
                new String[] { "MASTERY_TYPE", "1", "Repair & Maintenance" },
                new String[] { "MASTERY_TYPE", "2", "Installation" }, new String[] { "MASTERY_TYPE", "3", "Gardening" },
                ...
                new String[] { "CONDITION", "1", "New" }, new String[] { "CONDITION", "2", "Used - Good" },
                new String[] { "CONDITION", "3", "Refurbished" },
                new String[] { "LISTING_TYPE", "0", "Sale" }, new String[] { "LISTING_TYPE", "1", "Rent" },
    ...
    private void seedUsers() throws IOException {
        ...
        userProfileRepo.saveAll(List.of(
                user("U001", "yassine", "Yassine", "El Ouardi", "Rabat", "Store owner for construction tools"),
                user("U002", "salma", "Salma", "Raji", "Casablanca", "Frequent customer and service buyer"),
                user("U003", "mehdi", "Mehdi", "Alaoui", "Marrakech", "Professional technician"),
                user("U004", "amina", "Amina", "Bennani", "Tangier", "Gardening and decoration provider"),
    ...
    private UserProfile user(String id, String username, String first, String last, String city, String bio)
        ...
        u.setBio(bio);
        u.setAvatarPhotoId(photoService.saveGeneratedImage(first + " " + last, "User avatar"));
    ...
    private void seedStores() throws IOException {
        ...
        s1.setLogo(photoService.saveGeneratedImage("Rabat Pro Tools", "Verified construction store"));
        ...
        s2.setLogo(photoService.saveGeneratedImage("Casa Digital Repairs", "IT services and electronics"));
    ...
    private void seedProducts() throws IOException {
        ...
        productRepo.saveAll(List.of(
                product("P001", "Professional Drill Bosch GSB 13", 1, 1, 1001,
                        ...
                        List.of("tool", "drill", "construction"), "U001", 1, 1, "Rabat", 34.020882, -6.84165, true,
                ...
                product("P002", "Electric Hammer Drill Makita", 1, 2, 1002,
                        ...
                        List.of("tool", "hammer", "drill"), "U002", 1, 1, "Casablanca", 33.573110, -7.589843, true,
                ...
                product("P003", "Portable Welding Machine 250A", 2, 3, 2001,
                        ...
                        List.of("welding", "metal", "construction"), "U003", 2, 1, "Marrakech", 31.629472, -7.981084,
                        true,
                ...
                product("P004", "Air Compressor 50L", 2, 4, 2002,
                        ...
                        List.of("compressor", "painting", "air"), "U004", 1, 1, "Tangier", 35.759465, -5.834000, true,
                ...
                product("P005", "Industrial Ladder 6m Aluminum", 3, 5, 3001,
                        ...
                        List.of("ladder", "construction", "safety"), "U005", 1, 1, "Fes", 34.018125, -5.007845, true,
                ...
                product("P006", "Electric Paint Sprayer Gun", 3, 6, 3002,
                        ...
                        List.of("painting", "sprayer", "tool"), "U006", 1, 1, "Agadir", 30.427755, -9.598107, true,
                ...
                product("P007", "Laser Distance Meter Bosch", 4, 1, 4001,
                        ...
                        List.of("laser", "measurement", "construction"), "U007", 1, 1, "Meknes", 33.893531, -5.547269,
                        true,
                ...
                product("P008", "Concrete Mixer Machine Small", 2, 7, 2003,
                        ...
                        List.of("cement", "construction", "mixer"), "U008", 2, 1, "Oujda", 34.681390, -1.908580, true,
                ...
                product("P009", "Electric Angle Grinder", 1, 2, 1003,
                        ...
                        List.of("grinder", "tool", "metal"), "U009", 1, 1, "Kenitra", 34.264300, -6.580100, true,
                ...
                product("P010", "Construction Safety Helmet Set", 5, 8, 5001,
                        ...
                        List.of("safety", "helmet", "construction"), "U010", 1, 1, "Tetouan", 35.588890, -5.362560,
                        true,
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1782646816/Construction_Safety_Helmet_Set_tim6so.png"))));
    }

    private Product product(String id, String name, int categoryId, int markId, int serieNum, String desc, int price,
            List<String> tags, String ownerId, int conditionId, int listedForId, String city, double lat, double lon,
            boolean available, List<String> photoUrls) throws IOException {
        ...
        if (photoUrls != null && !photoUrls.isEmpty()) {
            p.photoUrls = new ArrayList<>();
            for (String imageUrl : photoUrls) {
                try {
                    p.photoUrls.add(saveCloudinaryImage(imageUrl));
                } catch (Exception e) {
                    System.err.println("[Seeder] Image upload failed for: " + p.getName());
                    e.printStackTrace();
                }
            }
    ...
    private void seedMasteries() throws IOException {
        if (masteryRepo.count() > 0)
            return;
        masteryRepo.saveAll(List.of(

                mastery("M001", "Ali Ben", "0600000001", "Plumbing Repair", "ACTIVE", 1, "FIXED", 300, "Casablanca", 5,
                        "Expert plumber for home repairs",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396912/plumber_kyva3b.png")),
                mastery("M002", "Sara El", "0600000002", "House Painting", "ACTIVE", 2, "PER_HOUR", 150, "Rabat", 3,
                        "Interior and exterior painting services",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396902/painter_cpqwvi.png")),
                mastery("M003", "Youssef Amrani", "0600000003", "Electrical Installation", "ACTIVE", 1, "FIXED", 400,
                ...
                mastery("M004", "Fatima Zahra", "0600000004", "House Cleaning", "ACTIVE", 3, "PER_HOUR", 80,
                        "Marrakech", 2, "Professional home and office cleaning",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396899/house_wife_tpqq4x.png")),
                mastery("M005", "Omar Haddad", "0600000005", "Air Conditioning Repair", "ACTIVE", 1, "FIXED", 500,
                ...
                mastery("M006", "Nadia Bennis", "0600000006", "Babysitting", "ACTIVE", 4, "PER_HOUR", 70, "Rabat", 4,
                        "Certified childcare provider",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396901/nani_mm2cdj.png")),
                mastery("M007", "Khalid Idrissi", "0600000007", "Car Mechanic", "ACTIVE", 5, "FIXED", 600, "Casablanca",
                        8, "Full car diagnostics and repair",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396899/mechanic_awvqer.png")),
                mastery("M008", "Imane Chafik", "0600000008", "Graphic Design", "ACTIVE", 6, "PER_HOUR", 120,
                ...
                mastery("M009", "Mehdi Azizi", "0600000009", "Web Development", "ACTIVE", 6, "PER_HOUR", 200,
                ...
                mastery("M010", "Salma Raji", "0600000010", "Math Tutoring", "ACTIVE", 7, "PER_HOUR", 90, "Rabat", 6,
                        "High school math tutor",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396917/tutor_gb3hd5.png")),
                mastery("M011", "Hassan Ouali", "0600000011", "Roof Repair", "ACTIVE", 1, "FIXED", 700, "Fes", 10,
                        "Roofing and waterproofing expert",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396912/roofer_acriwt.png")),
                mastery("M012", "Rania Bakkali", "0600000012", "Makeup Artist", "ACTIVE", 8, "PER_HOUR", 250,
                ...
                mastery("M013", "Adil Najib", "0600000013", "Photography", "ACTIVE", 8, "FIXED", 800, "Marrakech", 7,
                        "Event and portrait photographer",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396903/photographer_tmrskx.png")),
                mastery("M014", "Laila Bennani", "0600000014", "Yoga Instructor", "ACTIVE", 9, "PER_HOUR", 100, "Rabat",
                ...
                mastery("M015", "Anas Fassi", "0600000015", "IT Support", "ACTIVE", 6, "PER_HOUR", 130, "Casablanca", 4,
                        "Technical IT troubleshooting",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396912/tech_support_b5wce8.png")),
                mastery("M016", "Hiba El Amrani", "0600000016", "Interior Design", "ACTIVE", 8, "FIXED", 1200,
                        "Tangier", 6, "Modern home interior designer",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396919/Designer_u7vac6.png")),
                mastery("M017", "Mustapha Reda", "0600000017", "Welding Services", "ACTIVE", 1, "FIXED", 450, "Fes", 9,
                        "Metal welding and fabrication",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396918/welder_dsxmz4.png")),
                mastery("M018", "Zineb Ghali", "0600000018", "Language Tutor", "ACTIVE", 7, "PER_HOUR", 110,
                ...
                mastery("M019", "Ayoub Jaber", "0600000019", "Delivery Service", "ACTIVE", 10, "FIXED", 60,
                ...
                mastery("M020", "Kawtar Mernissi", "0600000020", "Hair Stylist", "ACTIVE", 8, "PER_HOUR", 180, "Rabat",
                ...
                mastery("M021", "Yassine El Idrissi", "0600000021", "Security Services", "ACTIVE", 11, "FIXED", 500,
                ...
                mastery("M022", "Nour El Houda", "0600000022", "Catering Service", "ACTIVE", 12, "FIXED", 1500,
                ...
                mastery("M023", "Hamza Lahlou", "0600000023", "Computer Repair", "ACTIVE", 6, "PER_HOUR", 140, "Rabat",
                        4, "Laptop and desktop repair",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396902/pc_Repairman_yksecv.png")),
                mastery("M024", "Asmae Chraibi", "0600000024", "Translation Services", "ACTIVE", 7, "PER_HOUR", 120,
                        "Casablanca", 6, "Arabic, French, English translation",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396913/translator_rq8xam.png")),
                mastery("M025", "Othman Kabbaj", "0600000025", "Gardening", "ACTIVE", 3, "PER_HOUR", 90, "Tangier", 5,
                        "Garden maintenance and landscaping",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396920/gardner_msxrhu.png")),
                mastery("M026", "Ilham Boussaid", "0600000026", "Massage Therapy", "ACTIVE", 9, "PER_HOUR", 200,
                ...
                mastery("M027", "Redouane Fadil", "0600000027", "Furniture Assembly", "ACTIVE", 1, "FIXED", 250,
                ...
                mastery("M028", "Meryem Saidi", "0600000028", "Event Planning", "ACTIVE", 8, "FIXED", 2000, "Marrakech",
                        7, "Wedding and corporate event planner",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396911/traiteur_ysqp98.png")),
                mastery("M029", "Bilal Ait", "0600000029", "Locksmith", "ACTIVE", 1, "FIXED", 350, "Fes", 6,
                        "Emergency lock and key services",
                        List.of("https://res.cloudinary.com/dkmhbowlx/image/upload/v1780396900/locksmith_kvb4qa.png")),
                mastery("M030", "Siham Laaroussi", "0600000030", "Nutrition Coaching", "ACTIVE", 9, "PER_HOUR", 160,
    ...
    private Mastery mastery(String id, String masterId, String name, String phone, String title, int type,
            String pricing, int price, String city, int years, String desc, List<String> photoUrls) throws IOException {
    ...
    private void seedCommerce() {
        if (cartRepo.count() == 0) {
            ...
            c.setItems(new ArrayList<>(List.of(Cart.CartItem.builder().productId("P001")
                    ...
                    .listingType(Cart.CartItem.ListingType.RENT).startDate(LocalDate.now().plusDays(5))
                    .endDate(LocalDate.now().plusDays(7)).addedAt(LocalDateTime.now().minusHours(2)).build())));
            cartRepo.save(c);
        }
        if (orderRepo.count() == 0) {
            ...
            o.setItems(new ArrayList<>(List.of(Order.OrderItem.builder().productId("P003")
                    .productName("Portable Welding Machine 250A").ownerId("U003").price(3200).quantity(1)
                    .listingType(Cart.CartItem.ListingType.SALE).rentalDays(0).lineTotal(3200).build())));
        ...
        if (bookingRepo.count() == 0)
            bookingRepo.save(Booking.builder().id("B001").productId("P002").productName("Makita Hammer Drill")
                    .ownerId("U001").userId("U002").startDate(LocalDate.now().plusDays(10))
                    .endDate(LocalDate.now().plusDays(12)).quantity(1).dailyPrice(1200).durationDays(2).totalPrice(2400)
                    .status(Booking.BookingStatus.CONFIRMED).createdAt(LocalDateTime.now().minusDays(2))
        ...
        if (paymentRepo.count() == 0)
            paymentRepo.save(Payment.builder().id("PAY001").orderId("O001").userId("U002").provider("mock")
                    .providerSessionId("mock_seed_session").status(Payment.PaymentStatus.PAID).amount(3200)
                    .currency("MAD").checkoutUrl("/payments/mock/checkout/O001")
                    .createdAt(LocalDateTime.now().minusDays(8)).updatedAt(LocalDateTime.now().minusDays(7)).build());
    }
    ...
    private void seedMessaging() {
        ...
        chatMessageRepo.saveAll(List.of(
                ChatMessage.builder().id("MSG001").conversationId("CONV001").senderId("U002").receiverId("U001")
                        .body("Is the Bosch drill available next week?").read(true)
                        .createdAt(LocalDateTime.now().minusHours(5)).build(),
                ChatMessage.builder().id("MSG002").conversationId("CONV001").senderId("U001").receiverId("U002")
    ...
    private void seedNotifications() {
        ...
        notificationRepo.saveAll(List.of(
                Notification.builder().id("N001").userId("U002").type("ORDER_STATUS").title("Order confirmed")
                        .message("Your order INV-DEMO-001 has been confirmed.").referenceId("O001").read(false)
                        .createdAt(LocalDateTime.now().minusDays(7)).build(),
                Notification.builder().id("N002").userId("U001").type("NEW_MESSAGE").title("New message")
                        .message("A customer asked about Bosch Professional Drill.").referenceId("CONV001").read(true)
                        .createdAt(LocalDateTime.now().minusHours(5)).build()));
    }

    private void seedVendorVerifications() throws IOException {
        ...
        v.setDocumentPhotoId(photoService.saveGeneratedImage("Rabat Pro Tools", "Trade register demo document"));
        ...
        p.setDocumentPhotoId(photoService.saveGeneratedImage("Casa Digital Repairs", "Pending identity document"));
